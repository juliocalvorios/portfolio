  ...
  return (
    <div>
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold font-serif">The Developer</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4">
          <div className="bg-neutral-100 border border-neutral-200 aspect-[3/4] flex items-center justify-center mb-3">
            <div className="text-center">
              <div className="text-6xl text-neutral-300 mb-2">👤</div>
        ...
        <div className="lg:col-span-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              {/* Pull Quote */}
              <blockquote className="border-l-4 border-neutral-800 pl-4 mb-6">
          ...
          <div className="mt-8 pt-8 border-t border-neutral-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-neutral-50 border border-neutral-200 p-5">
                ...
                <p className="font-bold font-serif">Humber College</p>
              ...
              <div className="bg-neutral-50 border border-neutral-200 p-5">
                ...
                <p className="font-bold font-serif">veraOS Project</p>
                <p className="text-sm text-neutral-600">
          ...
          <div className="mt-8 pt-8 border-t border-neutral-200">
            ...
            <div className="bg-neutral-900 text-white p-6">
              ...
              <p className="font-serif leading-relaxed mt-4 text-neutral-300">
...
function SkillCategory({ title, skills }) {
  return (
    <div className="bg-neutral-50 border border-neutral-200 p-5">
      <p className="text-xs tracking-widest text-neutral-500 mb-3">
        {title.toUpperCase()}
      </p>
